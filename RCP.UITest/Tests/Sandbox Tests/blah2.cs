...
namespace RCP.UITest
{
    ...
    public class blah2 : TestBase
    {
        #region Constructors
        public blah2(string browserName) : base(browserName) { }

        // Remote Selenium Grid Test
        public blah2(string browserName, string version, string platform, string hubUri, string extrasUri)
